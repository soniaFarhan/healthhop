          ...
          <Modal.Body>
            <div className='row'>
              <div className="col ">
                ...
                <div className="row">
                  <div className=" col-sm-6  mb-2"><input type="text" className='py-2 form-control' placeholder='Name' /></div> </div>
                ...
                <div className="row"><div className='  col-sm-6 py-3'>
                  {/* <Autocomplete
              ...
              /> */}
                ...
                <div className="row"> <div className="  col-sm-6  mb-2">
                  <Rating
                    className='py-3 form-control'
                    name="simple-controlled" />
                </div></div>
                <div className="row"><div className="col-sm-6"><TextField
                  className=' '
                  hidden
                  type="file"
                  id="q"
                ...
                />
                  <label
                    className="px-2  text-center py-3 my-auto"
                    htmlFor="q"
                    style={{
