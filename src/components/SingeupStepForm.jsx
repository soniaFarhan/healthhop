...
<div className=""style={{}}>
    ...
    <div className="d-flex justify-content-center align-items-center layout" style={{background:"white",}}>
        <div className=" my-5 rounded-4 shadows " style={{backgroundColor:"shadows",width:"550px"}}>
       ...
       {step === 1 &&
        ...
        />
          ...
          <div className="my-3"  style={{ position: step === 1 ? "absolute" : "relative"}} >

         
          <button className='btn ms-2 py-3' onClick={prevStep}> <ArrowBack /></button>
...
{ step===1 &&
            <div className="text-center"> <Link to="/?method=patient">
            <Button
              style={{
...
const Step5=()=>{
    ...
    <div className="content">
    <h6 className='text-center'>
          Choose the Language, you want to <br /> provide 
          your services in
        </h6>
      <div class="form-check my-4 ">
        <input
